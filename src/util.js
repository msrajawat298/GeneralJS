 ...
 */
export const checkIsEmpty = (enter) => enter === '';
 ...
 */
export const operation = (n1, n2, operator) => {
 ...
 */
export const maxNumber = (numbers, type) => {
  let callerType = 'max';
  if (type === 'min') {
    callerType = 'min';
  }
 ...
 */
export const generateOTP = (lengthOfOtp) => {
 ...
 */
export const checkNumber = (string) => typeof string === 'number' || typeof string === 'string';
 ...
 */
export const checkPveNve = (numbr) => {
 ...
 */
export const isDivisibleby7 = (number) => {
 ...
 */
export const reverse = (entVal) => entVal.split('').reverse().join('');
 ...
 */
export const exponents = (baseNumber, exponentNumber) => {
  let exp = 1;
